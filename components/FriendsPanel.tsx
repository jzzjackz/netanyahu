...
export default function FriendsPanel() {
  ...
  return (
    <div className="flex w-60 flex-shrink-0 flex-col bg-[#2b2d31]">
      {/* Search/Filter bar */}
      <div className="border-b border-[#1e1f22] px-2 py-2">
        <input
          type="text"
          placeholder="Find or start a conversation"
          className="w-full rounded bg-[#1e1f22] px-2 py-1.5 text-sm text-[#dbdee1] placeholder-[#80848e] outline-none focus:outline-none"
        />
      </div>
