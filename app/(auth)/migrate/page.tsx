    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-[#1e1f22] text-white">
      <div className="w-full max-w-md rounded-md bg-[#313338] p-8 shadow-lg">
        <div className="mb-6 flex justify-center">
          <svg className="h-16 w-16 text-[#5865f2]" viewBox="0 0 71 55" fill="currentColor">
        ...
        <p className="mb-6 text-center text-sm text-gray-400">
          Connect your Discord account to transfer your profile information to Commz
        </p>

        <div className="space-y-4">
          <div className="rounded-lg bg-[#2b2d31] p-4">
            <h3 className="mb-2 text-sm font-semibold">What we'll transfer:</h3>
            <ul className="space-y-1 text-xs text-gray-400">
              <li className="flex items-center gap-2">
                <span className="text-green-400">✓</span> Username
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-400">✓</span> Profile picture
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-400">✓</span> Bio (if available)
              </li>
            </ul>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded bg-[#5865f2] px-4 py-3 text-sm font-semibold transition hover:bg-[#4752c4] disabled:cursor-not-allowed disabled:opacity-70"
          >
            {loading ? (
              "Connecting..."
            ) : (
          ...
          <div className="text-center">
            <a href="/login" className="text-xs text-gray-400 hover:text-gray-300">
              Back to login
            </a>
          </div>
        </div>
