  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#1e1f22] text-white">
      <div className="w-full max-w-md rounded-md bg-[#313338] p-8 shadow-lg">
        ...
        <div className="mt-6 border-t border-[#404249] pt-6">
          <a
            href="/migrate"
            className="flex w-full items-center justify-center gap-2 rounded bg-[#5865f2] px-4 py-2.5 text-sm font-semibold transition hover:bg-[#4752c4]"
          >
            ...
            Migrating from Discord? Click here!
          </a>
        </div>
      </div>
    </div>
